...
#WALLPAPER
xfconf-query --channel xfce4-desktop --property /backdrop/screen${SCREEN}/monitor${MONITOR}/workspace0/last-image --set ~/Pictures/wall/raindrops-2_FHD.jpg
...
##windows tweaks
xfconf-query -c xfwm4 -p /general/theme -s Arc-Darker-solid
