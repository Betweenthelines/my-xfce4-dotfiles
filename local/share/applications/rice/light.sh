...
#WALLPAPER
xfconf-query --channel xfce4-desktop --property /backdrop/screen${SCREEN}/monitor${MONITOR}/workspace0/last-image --set ~/Pictures/wall/cherry-blossoms_FHD.jpg
...
xfconf-query -c xfce4-terminal -p /color-foreground -s '#585260'
