...
style=("Light" "Dark" "mint" "mint-light" "gruvbox-dark" "Everforest" "The best" "Juno" "Kripton" "Nordic-bluish" "Nordic-polar" "Robust" "Comic" "true-dark" "Anime" "exit")
	   ...
	   ~/.local/share/applications/rice/Win95.sh
        ...
        "Comic")
         ...
         "true-dark")
            ...
            ;;
            "Anime")
            echo "Anime gtk theme"
            ~/.local/share/applications/rice/anime.sh
            ;;
            "exit")
